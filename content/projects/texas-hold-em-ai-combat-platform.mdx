...
tags: ["Unity", "AI", "Tooling", "Networking", "Simulation"]
highlight: false
cover: ""
links:
...
import thLobby from "./texas-hold-em-ai-combat-platform/1280X1280.png";
import thOverlay from "./texas-hold-em-ai-combat-platform/1280X12802.png";
import thRound from "./texas-hold-em-ai-combat-platform/ef3cf60d-972a-48eb-a56e-e988dd6180a6-1.png";
import thCsharp from "./texas-hold-em-ai-combat-platform/Screenshot2023-12-21at2.44.09AM-1.png";
import thLua from "./texas-hold-em-ai-combat-platform/Screenshot2023-12-21at2.48.13AM-4.png";
...
<Gallery
  images={[
    { src: thLobby, alt: "Lobby configuration" },
    { src: thOverlay, alt: "Live match overlay" },
    { src: thRound, alt: "Round summary" },
  ]}
/>
...
<img src={thCsharp} alt="C# interface skeleton and gamestat payload" />

<img src={thLua} alt="Lua module contract" />
