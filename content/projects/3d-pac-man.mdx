...
date: "2025-09-13"
role: ["Programmer"]
summary: "3D modernization of Pac-Man built with AniGraph and Three.js for Cornell's CS4620 practicum, complete with stylized shading, smarter ghosts, and procedural mazes."
tags: ["Three.js", "Graphics", "Gameplay", "Procedural Generation", "AI"]
highlight: false
cover: ""
links:
  [
    { label: "Original Page", href: "https://xiaoyuejin.com/3d-pac-man/" },
    {
...
For the CS4620: Intro to Computer Graphics final, our team rebuilt Pac-Man in 3D using Cornell's AniGraph framework and Three.js. We rebalanced classic mechanics with new rendering tech—stylized shading, volumetric effects, and smarter enemy behaviors—to keep the original spirit while showcasing a modern pipeline.
...
![Gameplay capture showing toon-shaded Pac-Man maze](/projects/3d-pac-man/Screenshot2023-12-21at3.54.54AM-3.png)
