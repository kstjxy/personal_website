...
const HeroHeader: React.FC<HeroHeaderProps> = ({ title, image, alt = "", meta }) => {
  return (
    <div className="relative h-[220px] w-full overflow-hidden bg-muted md:h-[360px]">
      <img
        src={image}
        alt={alt}
      ...
      <div className="absolute bottom-6 left-6 right-6">
        <h1 className="text-3xl font-bold text-white drop-shadow-sm md:text-5xl">{title}</h1>
